/* $Header: /home/cvs/bp/oofem/sm/src/q4axisymm.C,v 1.3 2003/04/06 14:08:31 bp Exp $ */
/*
...
// evaluated at aGaussPoint.
{
 ...
 if ((li <= 1) && (ui >= 1)) {
  for (i=1;i<=8;i++) answer.at(ind,2*i-1)=nx->at(i)*inv.at(1,1)+ny->at(i)*inv.at(1,2);
  ind ++;
 }

 if ((li <=2) && (ui >= 2)) {
  for (i=1;i<=8;i++) answer.at(ind,2*i-0)=nx->at(i)*inv.at(2,1)+ny->at(i)*inv.at(2,2);
  ind ++;
 }
