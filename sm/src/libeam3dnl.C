/* $Header: /home/cvs/bp/oofem/sm/src/libeam3dnl.C,v 1.4 2003/04/06 14:08:30 bp Exp $ */
/*
...
LIBeam3dNL :: giveInternalForcesVector (FloatArray& answer, 
 ...
 if (GNTflag) answer.rotatedWith (GNT,'n');
...
LIBeam3dNL :: giveEdgeDofMapping (IntArray& answer, int iEdge) const
{
 ...
 int i;
  ...
  if (iEdge != 1) _error ("giveEdgeDofMapping: wrong edge number");
