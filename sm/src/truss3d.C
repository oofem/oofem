...
{
 if (interface == DirectErrorIndicatorRCInterfaceType) return (DirectErrorIndicatorRCInterface*) this;
 return NULL;
}
   ...
   // Sets up the array of Gauss Points of the receiver.
{
  ...
  integrationRulesArray[0]->setUpIntegrationPoints (_Line, 1, this, _1dMat);
...
//
{
 ...
 int minIndx = 1;
 for (i=2; i<=3; i++) {
  if (lx.at(i) < lx.at(minIndx)) minIndx = i;
 }
 help.zero(); help.at(minIndx) = 1.0;
