/* $Header: /home/cvs/bp/oofem/sm/src/piecewisper.C,v 1.3 2003/04/06 14:08:31 bp Exp $ */
/*
   ...
   // tion between two points).
{
   ...
   if (addTF) add = domain->giveLoadTimeFunction(addTF)->__at(time);
   else add = 0.;
   ...
   // tion between two points).
{
   ...
   if (addTF) add = domain->giveLoadTimeFunction(addTF)->__derAt(time);
   else add = 0.;
