/* $Header: /home/cvs/bp/oofem/sm/src/Attic/interfaceelem2dquad.C,v 1.1.2.1 2004/04/05 15:19:47 bp Exp $ */
/*
   ...
   // Gauss point is used.
{
  ...
  double thickness   = this -> giveCrossSection() -> give('t');
...
void InterfaceElem2dQuad :: drawRawGeometry (oofegGraphicContext& gc)
{
  ...
  p[0].x = (FPNum) this->giveNode(2)->giveCoordinate(1);
  p[0].y = (FPNum) this->giveNode(2)->giveCoordinate(2);
  p[0].z = 0.0;
...
void InterfaceElem2dQuad :: drawScalar   (oofegGraphicContext& context)
{
  ...
  if (context.giveIntVarMode() == ISM_recovered) return;
