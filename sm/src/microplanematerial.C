/* $Header: /home/cvs/bp/oofem/sm/src/microplanematerial.C,v 1.4 2003/04/06 14:08:31 bp Exp $ */
/*
...
{
 if (masterMode == _3dMat) return _3dMicroplane;
 return _Unknown;
}
...
MicroplaneMaterial::initTempStatus (GaussPoint* gp)
{
 ...
 MaterialStatus* status;
  ...
  if (status) status->initTempStatus();
  }
}
