/* $Header: /home/cvs/bp/oofem/sm/src/concrete3.C,v 1.4 2003/04/06 14:08:30 bp Exp $ */
/*
...
Concrete3 :: initializeFrom (InputRecord* ir)
{
 ...
 if (exmode) softeningMode = exponentialSoftening; else softeningMode = linearSoftening;
