...
The OOFEM is divided into several modules. The module OOFEM core, introduces the fundamental, core classes. These classes are problem independent
...
The OOFEM core module is the compulsory module, that is always included in all builds. The other modules are optional and can be included or excluded from the build, depending on the user configuration.
