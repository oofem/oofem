...
\end{eqnarray}
In OOFEM, the strain vector is arranged as $\{\varepsilon_{x}, \varepsilon_{y}, \varepsilon_{\theta}, 0, 0, \gamma_{xy}\}^T$ and the stress vector $\{\sigma_{x}, \sigma_{y}, \sigma_{\theta}, 0, 0, \tau_{xy}\}^T$.
...
The element should be located in $x,y$ plane, where $x$ direction is the radial direction.
...
finite element. The element should be located in $x,y$ plane, where $x$ direction is the radial direction.
Each node has 2 degrees of freedom. Node numbering and edge position is the same as in Fig.~\ref{Planestress2dfig}. The element features are summarized in Table~\ref{l4axisymmsummary}.
