...
\newcommand{\elementSummaryBegin}[2]{
\begin{center}
\begin{table}[!htb]
 \begin{tabular}{|l|p{9cm}|}\hline
   {\bf Description} & {#1}\\
   \hline
   {\bf Specific parameters} & #2\\
   \hline
   Parameters &\\
}
...
\newcommand{\elementDescription}[2]{
  {#1} & {#2}\\
}
\newcommand{\elementSummaryEnd}[2]{
   \hline
   \end{tabular}
 \caption{{#1}}
 \label{#2}
...
\elementSummaryBegin{{\bf truss1d} - 1D truss element}{-}
...
\elementSummaryEnd{truss1d element summary}{truss1dsummary}
...
\elementSummaryBegin{{\bf truss2d} - 2D truss element}{\optField{cs}{in}}
...
to 1}
\elementDescription{Status}{Reliable}
\elementSummaryEnd{truss2d element summary}{truss2dsummary}
...
\elementSummaryBegin{{\bf truss3d} - 3D truss element}{-}
...
provided.}
\elementDescription{Status}{Reliable}
\elementSummaryEnd{truss3d element summary}{truss3dsummary}
...
\elementSummaryBegin{{\bf beam2d} - 2D beam element}{\optField{dofstocondense}{ia}}
...
\elementDescription{Status}{Reliable}
\elementSummaryEnd{beam2d element summary}{beam2dsummary}
...
\elementSummaryBegin{{\bf beam3d} - 3D beam element}{\field{refnode}{in} \optField{dofstocondense}{ia}}
...
\elementDescription{Status}{Reliable}
\elementSummaryEnd{beam3d element summary}{beam3dsummary}
...
\elementSummaryBegin{{\bf lattice2d} element}{\field{thick}{rn} \field{width}{rn} \field{gpCoords}{ra}}
...
\elementSummaryEnd{lattice2d element summary}{lattice2dsummary}
...
\elementSummaryBegin{{\bf planestress2d} - 2D quadrilateral element for plane stress analysis}{\optField{NIP}{in}}
...
\elementDescription{Status}{Reliable}
\elementSummaryEnd{planestress2d element summary}{planestress2dsummary}
...
\elementSummaryBegin{{\bf qplanestress2d} - 2D quadratic isoparametric plane stress element}{\optField{NIP}{in}}
\elementParam{\param{NIP}: allows to set the number of integration points}
\elementDescription{Unknowns}{Two dofs (u-displacement, v-displacement) are required in each node.}
...
\elementSummaryEnd{qplanestress2d element summary}{qplanestress2dsummary}
...
\elementSummaryBegin{{\bf trplanestress2d} - 2D linear triangular isoparametric plane stress element}{-}
\elementDescription{Unknowns}{Two dofs (u-displacement, v-displacement) are required in each node.}
\elementDescription{Approximation}{Linear approximation of displacements and geometry.}
...
\elementDescription{Nlgeo}{0, 1.}
\elementDescription{Status}{Reliable}
\elementSummaryEnd{trplanestress2d element summary}{trplanestress2dsummary}
...
\elementSummaryBegin{{\bf qtrplstr} - 2D quadratic triangular plane stress element}{\optField{NIP}{in}}
\elementParam{\param{NIP}: allows to set the number of integration points}
\elementDescription{Unknowns}{Two dofs (u-displacement, v-displacement) are required in each node.}
\elementDescription{Approximation}{Quadratic approximation of displacements and geometry.}
...
\elementSummaryEnd{qtrplstr element summary}{qtrplstrsummary}
...
\elementSummaryBegin{{\bf trplanestrrot} - 2D linear triangular plane stress element with rotational DOFs}{\optField{NIP}{in} \optField{NIPRot}{in}}
\elementParam{\param{NIP}: allows to set the number of integration points for integration of membrane terms.}
\elementParam{\param{NIPRor}: allows to set the number of integration points for integration of terms associated to rotational field.}
...
\elementDescription{Status}{-}
\elementSummaryEnd{trplanestrrot element summary}{trplanestrrotsummary}
...
\elementSummaryBegin{{\bf quad1planestrain} - 2D linear quadrilateral plane-strain element}{\optField{NIP}{in}}
\elementParam{\param{NIP}: allows to set the number of integration points for integration of membrane terms.}
\elementDescription{Unknowns}{Two dofs (u-displacement, v-displacement) are required in each node.}
\elementDescription{Approximation}{Linear approximation of displacements and geometry.}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementSummaryEnd{quad1planestrain element summary}{quad1planestrainsummary}
...
\elementSummaryBegin{{\bf trplanestrain} - 2D linear triangular plane-strain element}{-}
%\elementParam{\param{NIP}: allows to set the number of integration points for integration of membrane terms.}
\elementDescription{Unknowns}{Two dofs (u-displacement, v-displacement) are required in each node.}
\elementDescription{Approximation}{Linear approximation of displacements and geometry.}
\elementDescription{Integration}{Integration of membrane strain terms using one point gauss integration formula.}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementSummaryEnd{trplanestrain element summary}{trplanestrainsummary}
...
\elementSummaryBegin{{\bf cctplate} - 2D constant curvature triangular plate element}{-}
%\elementParam{\param{NIP}: allows to set the number of integration points for integration of membrane terms.}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementSummaryEnd{cctplate element summary}{cctplatesummary}
...
\elementSummaryBegin{{\bf cctplate3d} - constant curvature triangular plate element in arbitray position}{-}
%\elementParam{\param{NIP}: allows to set the number of integration points for integration of membrane terms.}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementSummaryEnd{cctplate3d element summary}{cctplate3dsummary}
...
\elementSummaryBegin{{\bf rershell} - simple shell based on combination of CCT plate element (Mindlin hypothesis) with triangular plane stress element. element can be arbitrary positioned in space.}{-}
%\elementParam{\param{NIP}: allows to set the number of integration points for integration of membrane terms.}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementSummaryEnd{rershell element summary}{rershellsummary}
...
\elementSummaryBegin{{\bf tr\_shell01} - triangular shell element combining CCT3D plate element (Mindlin hypothesis) with triangular plane stress element with rotational DOFs}{-}
%\elementParam{\param{NIP}: allows to set the number of integration points for integration of membrane terms.}
\elementDescription{Unknowns}{Six dofs (u,v,w-displacements and u,v,w rotations) are in general required in each node.}
...
\elementDescription{Nlgeo}{0.}
\elementDescription{Status}{Reliable}
\elementSummaryEnd{tr\_shell01 element summary}{trshell01summary}
...
Implements the lumped mass matrix.

\elementSummaryBegin{{\bf quad1mindlin} -  quadrilateral, bilinear, four-node Mindlin plate}{\optField{NIP}{in}}
%\elementParam{\param{NIP}: allows to set the number of integration points for integration of membrane terms.}
...
\elementSummaryEnd{quad1mindlin element summary}{quad1mindlinsummary}
...
\descitem{Parameters} \optField{NIP}{in} \optField{NIPfish}{in}\\
\descitem{Unknowns}
...
\descitem{Integration}
Full integration of all strain components.
\param{NIP} parameter (possible completions are 1, 4 (default), 5, 11, 15, 24, and 45 allows to change the integration formula.\\
\descitem{Nlgeo} 0, 1, 2.\\
\descitem{Status} 
...
\descitem{Integration}
Full integration of all strain components.
\param{NIP} parameter (possible completions are 2 (default) and 9 allows to change the integration formula.\\
\descitem{Nlgeo} 0, 1, 2.\\
\descitem{Status} 
...
\descitem{Parameters} \optField{refnode}{in} \optField{normal}{ra}\\
