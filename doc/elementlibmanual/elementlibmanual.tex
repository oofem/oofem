...
\subsubsection{Bondlink3dtruss element}
This class implements a bond link for connecting trusses and continuum elements for meshes in which the nodes of the trusses and continuum elements coincide. The bond area for this element is calculated from the length and diameter of the truss element that is bonded to the continuum as $A_{\mathrm{bond}} = \pi d l$, where $A_{\mathrm{bond}}$ is the bond area, $d$ is the reinforcement diameter and $l$ is the length of the element.
The input parameters for this element are shown in Table~\ref{bondlink3dtrusssummary}.
