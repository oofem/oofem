...
\descitem{Parameters} \elemparam{thick}{rn} \elemparam{width}{rn} \elemparam{gpCoords}{ra} \\
...
\begin{figure}[htb]
 \centering
  \raisebox{-0.5\height}{\input{wedge_lin.tikz}}
  \caption{LWedge element. Definition and node numbering convention.}
  \label{linwedge_fig}
\end{figure}
...
\begin{figure}[htb]
 \centering
  \raisebox{-0.5\height}{\input{wedge_quad.tikz}}
  \caption{QWedge element. Definition and node numbering convention.}
  \label{qwedge_fig}
\end{figure}
...
Implementation of quadratic 3d 20-node 
finite element. Each node has 1 degrees of freedom. See section ~\ref{QSpace_element} 
