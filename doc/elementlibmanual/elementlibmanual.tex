...
\elemkeyword{truss2d}\\
\descitem{Parameters} \optField{cs}{in}\\
...
\elemkeyword{beam2d}\\
\descitem{Parameters} \optField{dofstocondense}{ia}\\
...
\elemkeyword{beam3d}\\
\descitem{Parameters} \field{refnode}{in}
\optField{dofstocondense}{ia}\\
...
\elemkeyword{lattice2d}\\
\descitem{Parameters} \field{thick}{rn} \field{width}{rn} \field{gpCoords}{ra} \\
The \param{thick} parameter is the out of plane ($z$-direction) thickness. 
The \param{width} parameter is the width of the midpoint cross-section in the $x$-$y$ plane with the point $C$ at its centre. 
The \param{gpCooords} parameter is an array of the coordinates of the integration point $C$ in the global coordinate system.
\descitem{Unknowns}
...
in 1, 4 (default), 9 or 16 integration points. The default number of
