...
zero RVOM values, exceeding the treshold. 
...
Active nodes are subsequently defined as nodes that are shared by at least one active element.
...
At present, some parameters, such as extrusion with, layer height, ambient temperature, bottom temperature, are hardcoded in the code and their change requires code recompilation.
