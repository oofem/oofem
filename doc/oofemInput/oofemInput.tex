...
\begin{record}[0.9\textwidth]
  ...
  \recentry{}{\optField{regionSets}{ia}}
  \recentry{}{\optFieldnotype{strain_energy}}
\end{record}
\begin{itemize}
...
\item \param{strain_energy} calculates strain energy over selected domains (defined by sets). It integrates stress over total strain differential in the volume. Strain energy increment and total strain energy is reported in each step. The integration uses mid-point rule for stress and yields exact results for linear elastic materials.
