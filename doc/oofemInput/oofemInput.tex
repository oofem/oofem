...
\optField{nonlocstiff}{in} \optField{nonlinform}{in}\\
...
\optField{stype}{in} \optField{regionstoskip}{ia}\\
...
\begin{figure}[!htb]
  \centerline{\includegraphics[width=0.99\textwidth]{ex01.pdf}}
  \caption{Beam structure example.}
  \label{ex01}
\end{figure}
...
\begin{figure}[!htb]
  \centerline{\includegraphics[width=0.99\textwidth]{ex02.pdf}}
  \caption{Plane stress example.}
  \label{ex02}
\end{figure}
{\small\begin{verbatim}
patch100.out
...
\begin{figure}[!htb]
  \centerline{\includegraphics[width=0.99\textwidth]{poofem_ex01.pdf}}
  \caption{Node-cut partitioning example: (a) whole geometry, (a) partition 0, (c) partition 1}
  \label{nodecut-ex01}
\end{figure}
...
\begin{figure}[!htb]
  \centerline{\includegraphics[width=0.99\textwidth]{poofem_ex02.pdf}}
  \caption{Element-cut partitioning example: (a) whole geometry, (a) partition 0, (c) partition 1.}
