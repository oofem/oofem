...
\begin{center}
\ifpdf
\oofemlnk{\centerline{\includegraphics[width=0.7\textwidth]{enrichmentitem_collab.pdf}}}
\else
\oofemlnk{\centerline{\includegraphics[width=0.7\textwidth]{enrichmentitem_collab.eps}}}
\fi
...
\begin{center}
\ifpdf
\oofemlnk{\centerline{\includegraphics[width=0.7\textwidth]{integrationrule_collab.pdf}}}
\else
\oofemlnk{\centerline{\includegraphics[width=0.7\textwidth]{integrationrule_collab.eps}}}
\fi
