...
\item {\bf Griffith} definition, combining Rankine criterion in tension and 
Griffith's solution on inclined elipsoidal inclusion. This definition
handles materials in pure tension and also in compression, where
tensile stresses usually appear on the elipsoidal inclusion.
...
\begin{eqnarray}
\label{griffith2}
\tilde\varepsilon&=&{\del{1}{E}}\cdot{\del{-(\sigma_1-\sigma_3)^2}{8(\sigma_1+\sigma_3)}}
\end{eqnarray}
\end{itemize}
...
\item[7 -] Rankine and Griffith criterion eqs.~(\ref{griffith1})(\ref{griffith2})
