...
which would incorectly yield a larger amount of dissipated energy.
...
&- \param{E} Young modulus\\
&- \param{n} Poisson ratio\\
&- \param{ef} crack opening (not strain) when the tension stress vanishes\\
...
\elemparam{n}{rn}  \elemparam{e0}{rn}
\elemparam{ef}{rn} \elemparam{tAlpha}{rn} \elemparam{r}{rn}
\elemparam{tAlpha}{rn} [\elemparam{regionMap}{ia}]
[\elemparam{equivstraintype}{in}] [\elemparam{maxOmega}{rn}]\\
Parameters &- \param{num} material model number\\
&- \param{d} material density\\
&- \param{E} Young modulus\\
&- \param{n} Poisson ratio\\
