...
\begin{figure}[!htb]
  \centerline{\scalebox{0.5}{\includegraphics{constmodel.pdf}}}
...
\begin{figure}[!htb]
  \centerline{\scalebox{0.5}{\includegraphics{mmodel.pdf}}}
...
\end{equation}
\begin{figure}[!htb]
  \centerline{\scalebox{0.5}{\includegraphics{tension.pdf}}}
...
\end{equation}
\begin{figure}[!htb]
  \centerline{\scalebox{0.5}{\includegraphics{shearconf.pdf}}}
...
\end{equation}
\begin{figure}[!htb]
  \centerline{\scalebox{0.5}{\includegraphics{capmode.pdf}}}
...
\begin{figure}[!htb]
%\begin{center}
%\includegraphics[width=10cm]{dm_comp.pdf}
\centerline{\scalebox{0.8}{\includegraphics{dm_comp.pdf}}}
%\end{center}
...
The linear softening occurs after reaching a critical stress $f_t$ in mode I, see Fig. \ref{comp_softening}. Orientation of cracks is assumed to be orthogonal and aligned with orientation of material axis \cite[pp.236]{Bazant:98}. The transverse isotropy is generally lost upon fracture, material becomes orthotropic and six damage parameters $d_1, d_2, \ldots d_6$ are introduced.
...
\frac{1-d_1}{E_{11}} & -\frac{\nu_{21}}{E_{22}} & -\frac{\nu_{31}}{E_{33}} &0 &0 & 0\\
-\frac{\nu_{12}}{E_{11}} & \frac{1-d_2}{E_{22}} & -\frac{\nu_{32}}{E_{33}} &0& 0&0\\
-\frac{\nu_{13}}{E_{11}} & -\frac{\nu_{23}}{E_{22}} & \frac{1-d_3}{E_{33}} &0 &0 &0 \\
 0&0 &0 & \frac{(1-d_4)(1+\nu_{12})}{E_{22}} & 0&0 \\
 0& 0& 0& 0& \frac{1-d_5}{G_{31}} & 0\\
 0& 0&0 &0& 0& \frac{1-d_6}{G_{12}}
\end{array} \right]
\end{eqnarray}

The evolution of damage in 3D space is based on the evolution of strain in corresponding 1D direction according to \ref{comp_softening} and expressed as
\begin{eqnarray}
(1-d_i)E_i&=&\frac{\sigs_i}{\eps_i}\\
d_i &=& 1-\frac{\sigs_i}{E_i\epss_i}\\
\epss_{0,i} - \epss_{E,i} &=& \frac{2G_{f,i}}{f_{0,i} l_i}\\
\sigs_i&=&\frac{f_{0,i}(\epss_{0,i}-\epss_i)}{(\epss_{0,i}-\epss_{E,i})} = f_{0,i} - \frac{f_{0,i}^2l_i}{2G_{f,i}}(\epss_i-\epss_{E,i})
\end{eqnarray}
where $\epss_{0,i}$ is strain at zero stress, $f_{0,i}$ is maximum given stress, $\epss_{E,i}$ is strain at maximum stress, $G_{f,i}$ is fracture energy disregarding the characteristic size of finite element, $l_i$ is the characteristic length associated with element size and interpolation order. The solution is similar to section~\label{IsoDamMod} and proceeds in total strain and strees formulation. Fig.~\ref{comp_performance} shows a typical performance for damage in one direction.

\begin{figure}[!htb]
  \centerline{\includegraphics[width=0.7\textwidth]{Compodamagemat_test.png}}
  \caption{Typical loading/unloading material performance for homogenized stress and strain in direction$_{11}$. Note that damage parameter is common for tension and compression.}
...
[\elemparam{Tension\_f0\_Gf}{rn}] [\elemparam{Compres\_f0\_gf}{rn}] \\
Parameters 
