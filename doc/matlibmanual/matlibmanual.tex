...
Lattice elements have to be used with material models describing the constitutive behavior in the form of vector of tractions and rotational stress components, and strains and rotational strain components determined from displacement jumps smeared out over the element length. 
...
\subsubsection{Latticeplasticitydamage}
