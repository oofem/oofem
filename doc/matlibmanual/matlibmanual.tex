...
\elemparam{d}{rn} \optelemparam{talpha}{rn} \optelemparam{calpha}{rn} \elemparam{e}{rn} \elemparam{a1}{rn} \elemparam{a2}{rn}\\
Parameters &- \param{} material number\\
&- \param{d} material density\\
&- \optparam{talpha} Thermal strain expansion coefficient. Optional parameter. Default is 0.\\
...
&- \optparam{a1} ratio of shear and normal modulus. Optional parameter. Default is 1.\\
&- \optparam{a2} ratio of rotational and normal modulus. Optional parameter. Default is 1.\\
&-
...
Parameters &- \param{} material number\\
&- \param{d} material density\\
&- \optparam{talpha} Thermal strain expansion coefficient. Optional parameter. Default i 0.\\
&- \optparam{calpha} thermal displacement expansion coefficient. Optional parameter. Default is 0.\\
...
&- \optparam{stype} softening types: 1-linear, 2-bilinear and 3-exponential. Optional parameter. Default is 1.\\
&- \param{wf} displacement threshold related to fracture energy used in all three softening types.\\
&- \optparam{wf1} displacement threshold related to softening type 2. Optional parameter. Default is wf1=0.15 wf.\\
&- \optparam{e01} strain threshold related to softening type 2. Optional parameter. Default is wf1=0.15 wf\\
...
\begin{equation}
\boldsymbol{\sigma} = \left(1-\omega\right) \mathbf{D}_{\rm e} \left(\boldsymbol{\varepsilon}-\boldsymbol{\varepsilon}_{\rm p}
\end{equation}
...
&- \optparam{wf1} displacement threshold related to softening type 1. Optional parameter. Default is wf1=0.1 wf.\\
&- \optparam{ft1} stress threshold related to softening type 1. Optional parameter. Default is ft1=0.15 ft.\\
strain threshold related to softening type 2. Optional parameter. Default is wf1=0.15 wf\\
...
This is an elasto-plastic model for slip between fibres modelled three-dimensional beam elements and lattice link elements.

The theory of the model is described in the paper \textit{P. Grassl and A. Antonelli. "3D network modelling of fracture processes in fibre-reinforced geomaterials", International Journal of Solids and Structures, vol. 156-157, Pages 234-242, 2019.}

\subsubsection{Bond lattice model}
This is an elasto-plastic-damage model for modelling the bond between two parts modelled with lattice elements.
