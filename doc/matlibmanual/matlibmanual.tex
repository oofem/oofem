...
&- \param {afterIter} how many iterations must pass until damage is computed from strains. User must ensure that the solver proceeds the minimum number of iterations.\\
\hline
\end{tabular}
