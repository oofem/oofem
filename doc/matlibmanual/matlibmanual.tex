...
&- \param{rateflag} flag which allows for the consideration of the effect of strain rates (using CEB-FIP Model code 2010) if set to 1, 2 or 3. Default value 0 which corresponds to no strain rate effect.\\
\begin{itemize}\setlength{\itemsep}{-3pt}
\item[1 -] CEB-Model code 2010 rate factor for strength and square rate factor for fracture energy  
\item[2 -] CEB-Model code 2010 rate factor for strength and fracture energy
\item[3 -] CEB-Model code 2010 rate factor for strength and no rate factor for fracture energy
\end{itemize}\\
