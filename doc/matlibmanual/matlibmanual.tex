...
$$
\tilde\varepsilon = \sqrt{\langle w_n\rangle^2 + \beta w_t^2}}
$$ 
where $\langle w_n\rangle$ is the positive part of the normal displacement jump (opening of the interface)
and $w_t$ is the norm of the tangential part of displacement jump (sliding of the interface). Parameter $\beta$
