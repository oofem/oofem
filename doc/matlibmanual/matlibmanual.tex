...
Please note, that there is only nine independent material parameters,
...
&- \param{NYyz}, \param{NYxz}, \param{NYxy} Poisson ratio
coefficients\\
...
\begin{figure}
  \centerline{\scalebox{0.5}{\includegraphics{constmodel.eps}}}
...
\begin{figure}
  \centerline{\scalebox{0.5}{\includegraphics{mmodel.eps}}}
...
\end{equation}
\begin{figure}
  \centerline{\scalebox{0.5}{\includegraphics{capmode.eps}}}
...
\centerline{\scalebox{0.8}{\includegraphics{dm_comp.eps}}}
%\end{center}
