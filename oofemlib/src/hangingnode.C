...
HangingNode :: computeMasterContribution ()
{
  ...
  case 211:{ FEI1dLin(0).evalN       (*masterContribution,*locoords,0.0); break; }  // linear truss
  case 312:{ FEI2dTrLin(0,0).evalN   (*masterContribution,*locoords,0.0); break; }  // linear triangle
  case 412:{ FEI2dQuadLin(0,0).evalN (*masterContribution,*locoords,0.0); break; }  // linear rectangle
  case 813:{ FEI3dHexaLin().evalN    (*masterContribution,*locoords,0.0); break; }  // linear hexahedron
  case 321:{
    ...
    masterContribution->at(3) = 1.0 - locoords->at(1) *  locoords->at(1);        break; }  // quadratic truss
  case 622:{
    ...
    masterContribution->at(6) =  4. * locoords->at(3) * locoords->at(1);       break; }  // quadratic triangle
  case 822:{
    ...
    masterContribution->at(8) = 0.5 * (1.+locoords->at(1)) * (1.-locoords->at(2)*locoords->at(2));    break;  } // quadratic rectangle
