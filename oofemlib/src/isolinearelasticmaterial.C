...
//
 ...
 if (!isActivated (atTime)) answer.times(0.0);
}
   ...
   //
{
 ...
 if (mode != _2dBeam) _error ("Give2dBeamStiffMtrx : unsupported mode");
   ...
   //
{
 ...
 if (mode != _3dBeam) _error ("give3dBeamStiffMtrx : unsupported mode");
 if (crossSection==NULL) _error("give3dBeamStiffMtrx : no SimpleCrossSection");
