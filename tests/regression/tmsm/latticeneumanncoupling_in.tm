latticeneumanncoupling_out.tm
tm part of lattice Neumann hydro-mechanical boundary coupling
TransientTransport nsteps 2 deltat 1.0 alpha 1. nmodules 0
...
latticemt2d 2 nodes 2 5 2 dim 2 mat 1 thick 1.0 width 1.0 gpCoords 2 2.0 1.0 crackwidth 0
latticemt2d 3 nodes 2 3 5 dim 2 mat 1 thick 1.0 width 1.0 gpCoords 2 1.0 1.25 crackwidth 0
...
BoundaryCondition 2 loadTimeFunction 1 dofs 1 11 values 1 -1.0 set 3
