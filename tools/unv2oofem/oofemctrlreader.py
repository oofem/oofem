...
#   Table of element properties. It contains mapping of nodes, edges and faces between unv and OOFEM element.
    ...
    #oofem_elemProp.append(oofem_elementProperties("TrPlaneStress2D", [0,2,1], [[0,2],[2,1],[1,0]],[])) #checked - old version of UNV export in SALOME, nodes on triangular elements are numbered clockwise
    oofem_elemProp.append(oofem_elementProperties("TrPlaneStress2D", [0,1,2], [[0,1],[1,2],[2,0]],[])) #checked - current numbering of triangle nodes is anti-clockwise, the same orientation as in OOFEM.
    ...
    oofem_elemProp.append(oofem_elementProperties("Py1supg", [0,1,2,3], [[0,1],[1,2],[2,0],[0,3],[1,3],[2,3]], [[0,1,2],[0,1,3],[1,2,3],[0,2,3]]))
