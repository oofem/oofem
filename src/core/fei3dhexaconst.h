...
public:
    ...
    const Element_Geometry_Type giveGeometryType() const override { return EGT_hexa_1; }
    const Element_Geometry_Type giveBoundaryGeometryType(int boundary) const override { return EGT_quad_1; } 
