...
IDGMaterial :: giveInternalLength(FloatMatrix &answer, MatResponseMode rMode, GaussPoint *gp, TimeStep *tStep)
{
    if ( averType == 0 ) {
        ...
        answer.resize(1, 1);
        FloatArray gpCoords;
        if ( gp->giveElementGeometry()->computeGlobalCoordinates( gpCoords, * ( gp->giveCoordinates() ) ) == 0 ) {
...
IDGMaterial :: givePDGradMatrix_uu(FloatMatrix &answer, MatResponseMode mode, GaussPoint *gp, TimeStep *tStep)
{
    ...
    case _PlaneStrain:
        ...
        break;
    default:
        OOFEM_ERROR("IDGMaterial :: givePDGradMatrix_uu - mMode = %d not supported\n", mMode);
    }
}
...
IDGMaterial :: givePDGradMatrix_ku(FloatMatrix &answer, MatResponseMode mode, GaussPoint *gp, TimeStep *tStep)
{
    ...
    case _PlaneStrain:
        ...
        break;
    default:
        OOFEM_ERROR("IDGMaterial :: givePDGradMatrix_ku - mMode = %d not supported\n", mMode);
    }
}
...
IDGMaterial :: givePDGradMatrix_uk(FloatMatrix &answer, MatResponseMode mode, GaussPoint *gp, TimeStep *tStep)
{
    ...
    case _PlaneStrain:
        ...
        break;
    default:
        OOFEM_ERROR("IDGMaterial :: givePDGradMatrix_uk - mMode = %d not supported\n", mMode);
    }
}
...
IDGMaterial :: givePDGradMatrix_kk(FloatMatrix &answer, MatResponseMode mode, GaussPoint *gp, TimeStep *tStep)
{
    ...
    case _PlaneStrain:
        ...
        break;
    default:
        OOFEM_ERROR("IDGMaterial :: givePDGradMatrix_kk - mMode = %d not supported\n", mMode);
    }
}
...
IDGMaterial :: givePDGradMatrix_LD(FloatMatrix &answer, MatResponseMode mode, GaussPoint *gp, TimeStep *tStep)
{
    ...
    case _PlaneStress:
        ...
        break;
    default:
        OOFEM_ERROR("IDGMaterial :: giveDPGradMatrix_LD - mMode = %d not supported\n", mMode);
    }
}
}     // end namespace oofem
