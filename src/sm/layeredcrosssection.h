...
protected:
 ...
 double      area;
  ...
  { numberOfLayers = 0; totalThick = 0.; area = -1.0;}
 ...
 void
  giveCharMaterialStiffnessMatrix  (FloatMatrix& answer,
 ...
 */
  ...
  */
  ...
  { _error ("packUnknowns: not implemented"); return 0;}
  /**
  ...
  */
  ...
  {_error ("unpackAndUpdateUnknowns: not implemented"); return 0;}
 /**
 ...
 int estimatePackSize (CommunicationBuffer& buff, GaussPoint* ip)
  {_error ("estimatePackSize: not implemented"); return 0;}
#endif
