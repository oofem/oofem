/* $Header: /home/cvs/bp/oofem/sm/src/quad1planestrain.h,v 1.1 2003/04/06 14:08:31 bp Exp $ */
/*
 *
 *                 #####    #####   ######  ######  ###   ###
 *               ##   ##  ##   ##  ##      ##      ## ### ##
...
protected:
    ...
    // GaussPoint    **gaussPointArrayShear;
    // int           numberOfShearGaussPoints;

public:
    Quad1PlaneStrain(int, Domain *); // constructor
    ~Quad1PlaneStrain();           // destructor
