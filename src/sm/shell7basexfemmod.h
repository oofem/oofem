...
#ifndef ModShell7BaseXFEM_h
#define ModShell7BaseXFEM_h
...
//@{
#define _IFT_ModShell7BaseXFEM_CohesiveZoneMaterial "czmaterial"
//@}
 ...
 */
#define _ExportCZ
class ModShell7BaseXFEM : public ModShell7Base, public XfemElementInterface
{
protected:
    XfemManager *xMan;
...
public:
    ModShell7BaseXFEM(int n, Domain * d);
    virtual ~ModShell7BaseXFEM();
    virtual int checkConsistency();

    void giveMaxCZDamages(FloatArray &answer, TimeStep *tStep);
    virtual const char *giveClassName()  const { return "ModShell7BaseXFEM"; }
