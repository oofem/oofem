...
void
Q9PlaneStress2d :: computeBmatrixAt(GaussPoint *aGaussPoint, FloatMatrix &answer, int li, int ui)
...
void
Q9PlaneStress2d :: computeNmatrixAt(GaussPoint *aGaussPoint, FloatMatrix &answer)
...
double
Q9PlaneStress2d :: computeVolumeAround(GaussPoint *aGaussPoint)
...
#ifdef __OOFEG
// TODO: Implement the functions within this ifdef
void Q9PlaneStress2d :: drawRawGeometry(oofegGraphicContext &gc)
{
    WCRec p [ 4 ];
    GraphicObj *go;
...
void Q9PlaneStress2d :: drawDeformedGeometry(oofegGraphicContext &gc, UnknownType type)
{
    WCRec p [ 4 ];
    GraphicObj *go;
...
void Q9PlaneStress2d :: drawScalar(oofegGraphicContext &context)
{
...
void
Q9PlaneStress2d :: computeEgdeNMatrixAt(FloatMatrix &answer, int iedge, GaussPoint *aGaussPoint)
{
    /*
     *
