...
#ifndef mooneyrivlincompressiblematerial_h
#define mooneyrivlincompressiblematerial_h
...
//@{
#define _IFT_MooneyRivlinCompressibleMaterial_Name "mooneyrivlincompresssiblemat"
