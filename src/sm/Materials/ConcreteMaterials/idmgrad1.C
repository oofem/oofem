...
void
IDGMaterialStatus :: saveContext(DataStream &stream, ContextMode mode)
{
...
void
IDGMaterialStatus :: restoreContext(DataStream &stream, ContextMode mode)
{
    IsotropicDamageMaterialStatus :: restoreContext(stream, mode);
