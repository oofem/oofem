...
void Node2SegmentLagrangianMultiplierContact::initializeFrom(InputRecord &ir)
{
...
void Node2SegmentLagrangianMultiplierContact::assemble(SparseMtrx &answer, TimeStep *tStep, CharType type, const UnknownNumberingScheme &r_s, const UnknownNumberingScheme &c_s, double scale, void *lock)
{
...
void Node2SegmentLagrangianMultiplierContact::assembleVector(FloatArray &answer, TimeStep *tStep, CharType type, ValueModeType mode, const UnknownNumberingScheme &s, FloatArray *eNorms, void *lock)
{
    IntArray dofIdArray = giveDomain()->giveDefaultNodeDofIDArry();
    /*IntArray dofIdArray = {
     *  D_u, D_v
