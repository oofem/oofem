...
REGISTER_Element( Tr2Shell7XFEMMod );

FEI3dTrQuad Tr2Shell7XFEMMod :: interpolation;

IntArray Tr2Shell7XFEMMod :: orderingDofTypes = {1, 2, 3, 8, 9, 10, 15, 16, 17, 22, 23, 24, 29, 30, 31, 36, 37, 38,
                        4, 5, 6, 11, 12, 13, 18, 19, 20, 25, 26, 27, 32, 33, 34, 39, 40, 41,
                        7, 14, 21, 28, 35, 42};
IntArray Tr2Shell7XFEMMod :: orderingNodes = {1, 2, 3, 19, 20, 21, 37, 4, 5, 6, 22, 23, 24, 38, 7, 8, 9, 25, 26, 27, 39,
                       10, 11, 12, 28, 29, 30, 40, 13, 14, 15, 31, 32, 33, 41, 16, 17, 18,
                       34, 35, 36, 42};
IntArray Tr2Shell7XFEMMod :: orderingEdgeNodes = {1, 2, 3, 10, 11, 12, 19, 4, 5, 6, 13, 14, 15, 20, 7, 8, 9, 16, 17, 18, 21};
		   

Tr2Shell7XFEMMod :: Tr2Shell7XFEMMod(int n, Domain *aDomain) : ModShell7BaseXFEM(n, aDomain)
{
    this->numberOfDofMans = 6;
}

const IntArray &
Tr2Shell7XFEMMod :: giveOrderingDofTypes() const
{
    return this->orderingDofTypes;
}

const IntArray &
Tr2Shell7XFEMMod :: giveOrderingNodes() const
{
    return this->orderingNodes;
}
const IntArray &
Tr2Shell7XFEMMod :: giveOrderingEdgeNodes() const
{
...
void 
Tr2Shell7XFEMMod :: giveLocalNodeCoords(FloatArray &nodeLocalXiCoords, FloatArray &nodeLocalEtaCoords)
{
...
FEInterpolation* Tr2Shell7XFEMMod :: giveInterpolation() const { return &interpolation; }


void 
Tr2Shell7XFEMMod :: computeGaussPoints()
{
...
bool Tr2Shell7XFEMMod :: updateIntegrationRule()
{
...
bool Tr2Shell7XFEMMod :: updateIntegrationRuleMultiCrack()
{
    bool partitionSucceeded = false;
    int nPointsTri  = 6;   // points in the plane
...
void
Tr2Shell7XFEMMod :: giveEdgeDofMapping(IntArray &answer, int iEdge) const
{
    /*
...
void 
Tr2Shell7XFEMMod :: giveSurfaceDofMapping(IntArray &answer, int iSurf) const
{
    answer.resize(42);
    for( int i = 1; i <= 42; i++){    
        answer.at(i) = i;
...
double 
Tr2Shell7XFEMMod :: computeAreaAround(GaussPoint *gp, double xi)
{
...
double 
Tr2Shell7XFEMMod :: computeVolumeAroundLayer(GaussPoint *gp, int layer)
{
    double detJ;
    FloatMatrix Gcov;
    FloatArray lcoords;
