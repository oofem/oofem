...
///@name Input fields for CSSRK3d
//@{
#define _IFT_CSSRK3d_Name "CSSRK3d"
#define _IFT_CSSRK3d_dofstocondense "dofstocondense"
#define _IFT_CSSRK3d_refnode "refnode"
#define _IFT_CSSRK3d_refangle "refangle"
#define _IFT_CSSRK3d_zaxis "zaxis"
//@}
...
/**
 * This class implements a 2-dimensional constant shear stress rectangle element
 * that can be arbitrary oriented in space
...
class CSSRK3d : public StructuralElement
{
protected:
...
public:
    ...
    virtual const char *giveClassName() const { return "CSSRK3d"; }
    virtual const char *giveInputRecordName() const { return _IFT_CSSRK3d_Name; }
