...
//@{
#define _IFT_BasicLSR3d_Name "basicLSR3d"
#define _IFT_BasicLSR3d_dofstocondense "dofstocondense"
#define _IFT_BasicLSR3d_refnode "refnode"
#define _IFT_BasicLSR3d_refangle "refangle"
#define _IFT_BasicLSR3d_zaxis "zaxis"
//@}
 ...
 * are done in local coordinate system, where the element possesses only 2 degrees of freedom
...
class BasicLSR3d : public StructuralElement
{
protected:
