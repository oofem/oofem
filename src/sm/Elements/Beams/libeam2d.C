...
{
    answer = this->giveStructuralCrossSection()->give2dBeamStiffMtrx(rMode, gp, tStep).toFloatMatrix();
}
...
{
    answer = this->giveStructuralCrossSection()->giveGeneralizedStress_Beam2d(strain, gp, tStep).toFloatArray();
}
