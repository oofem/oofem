...
#include "sm/Elements/Interfaces/intelsurfquad1.h"
#include "node.h"
...
FEI3dQuadLin IntElSurfQuad1 :: interpolation;

IntElSurfQuad1 :: IntElSurfQuad1(int n, Domain *aDomain) :
...
void
IntElSurfQuad1 :: computeNmatrixAt(GaussPoint *ip, FloatMatrix &answer)
{
...
void
IntElSurfQuad1 :: computeGaussPoints()
{
...
void
IntElSurfQuad1 :: computeCovarBaseVectorsAt(IntegrationPoint *ip, FloatArray &G1, FloatArray &G2)
{
    FloatMatrix dNdxi;
...
double
IntElSurfQuad1 :: computeAreaAround(IntegrationPoint *ip)
{
    FloatArray G1, G2, G3;
...
#if 0
bool
IntElSurfQuad1 :: computeGtoLRotationMatrix(FloatMatrix &answer)
{
    FloatMatrix lcs;
...
void
IntElSurfQuad1 :: computeTransformationMatrixAt(GaussPoint *gp, FloatMatrix &answer)
{
...
int
IntElSurfQuad1 :: computeGlobalCoordinates(FloatArray &answer, const FloatArray &lcoords)
{
...
bool
IntElSurfQuad1 :: computeLocalCoordinates(FloatArray &answer, const FloatArray &gcoords)
{
...
#ifdef __OOFEG
void IntElSurfQuad1 :: drawRawGeometry(oofegGraphicContext &gc, TimeStep *tStep)
{
    GraphicObj *go;
...
void IntElSurfQuad1 :: drawDeformedGeometry(oofegGraphicContext &gc, TimeStep *tStep, UnknownType type)
{ }


void IntElSurfQuad1 :: drawScalar(oofegGraphicContext &gc, TimeStep *tStep)
{ }
