...
public:
    ...
    const char *giveClassName() const { return "TrabBoneNLStatus"; }
...
public:
    ...
    const char *giveClassName() const { return "TrabBoneNL"; }
    classType   giveClassID()   const { return TrabBoneMaterialClass; }
    const char *giveInputRecordName() const { return "trabbonenl"; }
...
protected:
    ...
    MaterialStatus *CreateStatus(GaussPoint *gp) const { return new TrabBoneNLStatus(1, TrabBoneMaterial :: domain, gp); }
};
} // end namespace oofem
#define trabonenl_h
#endif
