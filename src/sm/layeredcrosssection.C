...
int
LayeredCrossSection :: setupIntegrationPoints(IntegrationRule &irule, int npoints, ElementGeometry *element)
{
...
double
LayeredCrossSection :: give(CrossSectionProperty aProperty, const FloatArray *coords, ElementGeometry *elem, bool local)
{
    if ( aProperty == CS_Thickness ) {
        return this->computeIntegralThick();
    } else if ( aProperty == CS_TopZCoord ) {
...
void
LayeredCrossSection :: setupLayeredIntegrationRule(IntegrationRule ** &integrationRulesArray, ElementGeometry *el, int numInPlanePoints)
{
...
LayeredIntegrationRule :: LayeredIntegrationRule(int n, ElementGeometry *e,
