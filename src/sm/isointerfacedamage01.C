/* $Header: /home/cvs/bp/oofem/sm/src/Attic/isointerfacedamage01.C,v 1.1.2.1 2004/04/05 15:19:47 bp Exp $ */
/*
...
//
{
 ...
 if (equivStrain >= 0.0) { de.times(1.0-omega); }
                                                                    ...
                                                                    GaussPoint* gp, TimeStep* atTime)
{
  ...
  if ((rMode == ElasticStiffness) || (rMode == SecantStiffness) || (rMode == TangentStiffness)) {
    ...
    if (rMode == ElasticStiffness) return;
