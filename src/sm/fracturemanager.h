...
public:
    ...
    FailureCriteriaStatus(ElementGeometry * el, FailureCriteria * failCrit)
    {
        this->el = el;
        this->failCrit = failCrit;
    }
...
public:
    ...
    virtual FailureCriteriaStatus *CreateStatus(ElementGeometry *el, FailureCriteria *failCrit) const = 0;
    virtual bool computeFailureCriteriaQuantities(FailureCriteriaStatus *fcStatus, TimeStep *tStep);
    virtual bool evaluateFCQuantities(ElementGeometry *el, TimeStep *tStep) { return false; }; // defaults to no implementation
...
{
public:
    DamagedNeighborLayeredStatus(ElementGeometry * el, FailureCriteria * failCrit) :
...
public:
    ...
    virtual FailureCriteriaStatus *CreateStatus(ElementGeometry *el, FailureCriteria *failCrit) const
