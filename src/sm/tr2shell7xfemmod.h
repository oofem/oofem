...
#ifndef Tr2Shell7XFEMMod_h
#define Tr2Shell7XFEMMod_h
...
#define _IFT_Tr2Shell7XFEMMod_Name "tr2shell7xfemmod"
...
public:
    Tr2Shell7XFEMMod(int n, Domain * d);
    virtual ~Tr2Shell7XFEMMod() { }     // destructor -> declaring as virtual will make each subclass call their respective destr.
    // definition & identification
    virtual int giveNumberOfEdgeDofs()       { return 21; }
    virtual int giveNumberOfEdgeDofManagers() { return 3;  }
    virtual const char *giveInputRecordName() const { return _IFT_Tr2Shell7XFEMMod_Name; }
    virtual const char *giveClassName() const { return "Tr2Shell7XFEMMod"; }
