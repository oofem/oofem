...
#ifndef druckerpragermat_h
#define druckerpragermat_h
 ...
 */
class DruckerPragerMat : public StructuralMaterial
{
protected:
...
public:
    DruckerPragerMat(int n, Domain *d);
    virtual ~DruckerPragerMat();
    ...
    virtual const char *giveClassName() const { return "DruckerPragerMat"; }
    virtual classType giveClassID() const { return DruckerPragerMatClass; }
...
class DruckerPragerMatStatus : public StructuralMaterialStatus
{
protected:
...
public:
    DruckerPragerMatStatus(int n, Domain *d, GaussPoint *g);
    virtual ~DruckerPragerMatStatus();
    ...
    virtual const char *giveClassName() const { return "DruckerPragerMatStatus"; }
    virtual classType giveClassID() const { return DruckerPragerMatStatusClass; }
};
} // end namespace oofem
#endif // druckerpragermat_h
