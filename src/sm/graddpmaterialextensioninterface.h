...
public:
    ...
    virtual void giveRealStressVectorGrad(FloatArray &answer1, double &answer2, GaussPoint *gp, const FloatArray &totalStrain, double nonlocalDamageDrivningVariable, TimeStep *atTime) { OOFEM_ERROR("giveRealStressVectorGrad is nor implemented") }
    virtual void giveFirstPKStressVectorGrad(FloatArray &answer1, double &answer2, GaussPoint *gp, const FloatArray &totalStrain, double nonlocalDamageDrivningVariable, TimeStep *atTime) { OOFEM_ERROR("giveFirstPKStressVectorGrad is nor implemented") }
    virtual void giveCauchyStressVectorGrad(FloatArray &answer1, double &answer2, GaussPoint *gp, const FloatArray &totalStrain, double nonlocalDamageDrivningVariable, TimeStep *atTime) { OOFEM_ERROR("giveCauchyStressVectorGrad is nor implemented") }
