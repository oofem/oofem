...
///@name Input fields for ForeignTemperatureField
//@{
#define _IFT_ForeignTemperatureField_Name "foreigntempfield"
//@}
 ...
 *
 */
class ForeignTemperatureField : public StructuralTemperatureLoad
{
private:
    Field* foreignField;
...
public:
     ...
     */
    ForeignTemperatureField(int n, Domain * d) : StructuralTemperatureLoad(n, d) { }
    /// Destructor
    virtual ~ForeignTemperatureField() { }
    ...
    virtual const char *giveInputRecordName() const { return _IFT_ForeignTemperatureField_Name; }
    virtual const char *giveClassName() const { return "ForeignTemperatureField"; }
