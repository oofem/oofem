...
*/
 ...
 loadVector(), displacementVector(), eigVec(), eigVal()
    {stiffnessMatrix = NULL; initialStressMatrix = NULL; 
     numberOfSteps = 1; nMethodLS = NULL; nMethod = NULL; ndomains = 1;}
  ~LinearStability () {delete  stiffnessMatrix; delete initialStressMatrix; 
