...
public:
    ...
    void updatePrimaryField(StructuralEngngModel &ioEngngModel, TimeStep *tStep, const FloatArray &iNewSol) { };
    void updatePrimaryField(StaticStructural &ioEngngModel, TimeStep *tStep, const FloatArray &iNewSol);
