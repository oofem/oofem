...
{
    /*
     * This class implements a Linear 3d  6 - node
...
public:
    ...
    //
    const char *giveClassName() const { return "LWedge"; }
    classType   giveClassID() const { return LWedgeClass; }
    Element_Geometry_Type giveGeometryType() const { return EGT_wedge_1; }
    virtual int  computeNumberOfDofs(EquationID ut) { return 18; }
    integrationDomain  giveIntegrationDomain() { return _Wedge; }
...
protected:
    ...
    int giveNumberOfIPForMassMtrxIntegration() { return 9; }
