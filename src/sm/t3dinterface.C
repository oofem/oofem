...
//  case EGT_hexa_2:
   ...
   break;
  case EGT_unknown:
    OOFEM_ERROR ("T3DInterface::createInput unknown element type");
  }
 }
...
//  case EGT_hexa_2:
 ...
 if(quads + hexas + pyrams + wedges == 0)tri_tetra = true;
 ...
 if(edges != 0){
  for(i = 1; i <= edges; i++){
   ...
   for (j=1; j<=2; j++)fprintf (outputStrem, " %d", ielem->giveNode(j)->giveNumber());
   fprintf (outputStrem, "\n");
  }
 }
 if(trias != 0){
  for(i = 1; i <= trias; i++){
   ...
   fprintf (outputStrem, "%d", i);
   for (j=1; j<=3; j++)fprintf (outputStrem, " %d", ielem->giveNode(j)->giveNumber());
   fprintf (outputStrem, "\n");
  }
 }
 if(quads != 0){
  for(i = 1; i <= quads; i++){
   ...
   fprintf (outputStrem, "%d", i);
   for (j=1; j<=4; j++)fprintf (outputStrem, " %d", ielem->giveNode(j)->giveNumber());
   fprintf (outputStrem, "\n");
  }
 }
 if(tetras != 0){
 ...
 if(pyrams != 0){
  for(i = 1; i <= pyrams; i++){
   ...
   fprintf (outputStrem, "%d", i);
   for (j=1; j<=5; j++)fprintf (outputStrem, " %d", ielem->giveNode(j)->giveNumber());
   fprintf (outputStrem, "\n");
  }
 }
 if(wedges != 0){
  for(i = 1; i <= wedges; i++){
   ...
   fprintf (outputStrem, "%d", i);
   for (j=1; j<=6; j++)fprintf (outputStrem, " %d", ielem->giveNode(j)->giveNumber());
   fprintf (outputStrem, "\n");
  }
 }
 if(hexas != 0){
  for(i = 1; i <= hexas; i++){
   ...
   fprintf (outputStrem, "%d", i);
   for (j=1; j<=8; j++)fprintf (outputStrem, " %d", ielem->giveNode(j)->giveNumber());
   fprintf (outputStrem, "\n");
  }
 }
