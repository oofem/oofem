...
#ifndef ModShell7Base_h
#define ModShell7Base_h
 ...
 * @date 2012-11-01
 */
class ModShell7Base : public NLStructuralElement, public NodalAveragingRecoveryModelInterface, public LayeredCrossSectionInterface, 
...
public:
    ...
    virtual const char *giveClassName() const { return "ModShell7Base"; }
//    virtual classType giveClassID() const { return ModShell7BaseClass; }
