...
public:
     ...
     */
    virtual int computeGlobalCoordinates(FloatArray &answer, const FloatArray &lcoords) = 0;
    /**
     * Computes the element local coordinates from given global coordinates.
     * @returns nonzero if successful (if point is inside element); zero otherwise
     */
    virtual bool computeLocalCoordinates(FloatArray &answer, const FloatArray &gcoords) = 0;
     ...
     */
    virtual int giveIPValue(FloatArray &answer, GaussPoint *aGaussPoint, InternalStateType type, TimeStep *atTime) = 0;
    //virtual int giveIPValueSize(InternalStateType type, GaussPoint *) = 0;
    //virtual InternalStateValueType giveIPValueType(InternalStateType type) = 0;
    //virtual int giveIntVarCompFullIndx(IntArray &answer, InternalStateType type) = 0;
