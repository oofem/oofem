...
IRResultType MatlabExportModule :: initializeFrom(InputRecord *ir)
{
...
void MatlabExportModule :: computeArea()
{
	Domain *domain  = emodel->giveDomain(1);
	xmax=domain->giveDofManager(1)->giveCoordinate(1); xmin=xmax; ymax=domain->giveDofManager(1)->giveCoordinate(2);  ymin=ymax;
...
void MatlabExportModule :: doOutput(TimeStep *tStep)
{
	FILE *FID;
...
void MatlabExportModule :: doOutputMesh(TimeStep *tStep, FILE *FID)
{
...
void MatlabExportModule :: doOutputData(TimeStep *tStep, FILE *FID)
{
	Domain *domain  = emodel->giveDomain(1);
...
void MatlabExportModule :: doOutputSpecials(TimeStep *tStep,	FILE *FID)
{
...
void MatlabExportModule :: initialize()
{

}
void MatlabExportModule :: terminate()
{

}
FILE * MatlabExportModule :: giveOutputStream(TimeStep *tStep)
{
	FILE *answer;
	...
	fileName = emodel->giveOutputBaseFileName();
