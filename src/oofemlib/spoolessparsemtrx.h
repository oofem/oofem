/* $Header: /home/cvs/bp/oofem/oofemlib/src/spoolessparsemtrx.h,v 1.1 2003/04/06 14:08:26 bp Exp $ */
/*
...
class SpoolesSparseMtrx : public SparseMtrx
{
 ...
 public:
  SpoolesSparseMtrx (int _type, int _nent, int _sflag, int n, int m) : SparseMtrx (n,m) 
   {type = _type; nent = _nent; sflag = _sflag; mtrx=NULL;}
  SpoolesSparseMtrx () : SparseMtrx () {type = SPOOLES_REAL; nent = 0; sflag = SPOOLES_SYMMETRIC; mtrx = NULL;}
  ...
  */
 virtual int buildInternalStructure (EngngModel* eModel, int di, UnknownType); 
 ...
 virtual int isAntisymmetric () const {if (this->type == SPOOLES_NONSYMMETRIC) return 1; else return 0;}
