 ...
 * @author Mikael Öhman
 *
 * @todo This class should contain the homogenization of the macroscopic tangents.
 */
...
public:
    ...
    virtual const char *giveClassName() const { return "MixedGradient"; }
    virtual classType giveClassID() const { return MixedGradientClass; }
};
} // end namespace oofem
