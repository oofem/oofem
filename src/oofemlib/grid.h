...
public:
  ...
  /// Destructor
    ...
    void setPrescribedField(double* PF, int size);
...
private:
    ...
    /// Array storing the values of the unknown (computed) field (e.g., arrival times)
    double* T;

    /// Array storing the values of the prescribed field (e.g., front velocities)
    double* F;
