   ...
   // Returns the n-th module.
{
 ...
 else OOFEM_ERROR2 ("ExportModuleManager::giveOuputModule: No module no. %d defined",num);
...
ExportModuleManager::instanciateYourself (DataReader* dr, InputRecord* ir)
{
 ...
 for (i=0; i < numberOfModules ; i++) {
  ...
  if (result != IRRT_OK) IR_IOERR (giveClassName(), __proc, IFT_RecordIDField, "", mir, result);
  // read type of module
