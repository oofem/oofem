...
class SlaveDof : public Dof
{
  ...
  */
  double giveLocalUnknown (EquationID, ValueModeType, TimeStep*) { _error ("HangingDof :: giveLocalUnknown: local coordinate system doesn't exist"); return 0.0; }
  ...
  */
  int giveEquationNumber (void) {_error ("giveEquationNumber: undefined"); return 0;}
  ...
  /**
     ...
     @return prints error msg and exits.
  */
  int givePrescribedEquationNumber (void) {_error ("givePrescribedEquationNumber: undefined"); return 0;}
  /**
