...
GaussIntegrationRule :: GaussIntegrationRule(int n, ElementGeometry *e,
...
GaussIntegrationRule :: giveTetCoordsAndWeights(int nPoints, FloatArray &coords_xi1, FloatArray &coords_xi2, FloatArray &coords_xi3, FloatArray &weights)
{
    ...
    default:
        OOFEM_ERROR("GaussIntegrationRule :: giveTetCoordsAndWeights: unsupported number of IPs (%d)", nPoints);
    }
}
