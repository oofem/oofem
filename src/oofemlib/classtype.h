...
enum classType {
    ...
    StVenantKirchhoffMaterialClass,
    StVenantKirchhoffOrthoMaterialClass,
    ...
    StVenantKirchhoffMaterialStatusClass,
    StVenantKirchhoffOrthoMaterialStatusClass,
