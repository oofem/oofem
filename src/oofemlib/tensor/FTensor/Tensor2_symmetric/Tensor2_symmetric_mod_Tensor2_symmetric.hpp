...
namespace FTensor
{
  ...
  class Tensor2_symmetric_mod_Tensor2_symmetric<A, B, T, U, Dim, Dim, i, j, i,
                                                j>
  {
  ...
  template <class A, class B, class T, class U, int Dim, char i, char j>
  class Tensor2_symmetric_mod_Tensor2_symmetric<A, B, T, U, Dim, Dim, i, j, j,
                                                i>
  {
    Tensor2_symmetric_Expr<A, T, Dim, i, j> iterA;
  ...
  template <class A, class B, class T, class U, int Dim_0, int Dim_1, char i0,
            char j0, char i1, char j1>
  Tensor2_symmetric_Expr<Tensor2_symmetric_mod_Tensor2_symmetric<
