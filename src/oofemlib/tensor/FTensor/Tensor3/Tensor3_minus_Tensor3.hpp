/* Subtracts a Tensor3 from a Tensor3, yielding a Tensor3. */
...
namespace FTensor
{
  ...
  class Tensor3_minus_Tensor3<A, B, T, U, Dim0, Dim1, Dim2, Dim0, Dim1, Dim2,
                              i, j, k, i, j, k>
  {
  ...
  template <class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
            char i, char j, char k>
  class Tensor3_minus_Tensor3<A, B, T, U, Dim0, Dim1, Dim2, Dim0, Dim2, Dim1,
                              i, j, k, i, k, j>
  {
    Tensor3_Expr<A, T, Dim0, Dim1, Dim2, i, j, k> iterA;
  ...
  template <class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
            char i, char j, char k>
  class Tensor3_minus_Tensor3<A, B, T, U, Dim0, Dim1, Dim2, Dim1, Dim0, Dim2,
                              i, j, k, j, i, k>
  {
    Tensor3_Expr<A, T, Dim0, Dim1, Dim2, i, j, k> iterA;
  ...
  template <class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
            char i, char j, char k>
  class Tensor3_minus_Tensor3<A, B, T, U, Dim0, Dim1, Dim2, Dim1, Dim2, Dim0,
                              i, j, k, j, k, i>
  {
    Tensor3_Expr<A, T, Dim0, Dim1, Dim2, i, j, k> iterA;
  ...
  template <class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
            char i, char j, char k>
  class Tensor3_minus_Tensor3<A, B, T, U, Dim0, Dim1, Dim2, Dim2, Dim0, Dim1,
                              i, j, k, k, i, j>
  {
    Tensor3_Expr<A, T, Dim0, Dim1, Dim2, i, j, k> iterA;
  ...
  template <class A, class B, class T, class U, int Dim0, int Dim1, int Dim2,
            char i, char j, char k>
  class Tensor3_minus_Tensor3<A, B, T, U, Dim0, Dim1, Dim2, Dim2, Dim1, Dim0,
                              i, j, k, k, j, i>
  {
    Tensor3_Expr<A, T, Dim0, Dim1, Dim2, i, j, k> iterA;
  ...
  template <class A, class B, class T, class U, int Dim0_0, int Dim1_0,
            int Dim2_0, int Dim0_1, int Dim1_1, int Dim2_1, char i0, char j0,
            char k0, char i1, char j1, char k1>
  Tensor3_Expr<Tensor3_minus_Tensor3<A, B, T, U, Dim0_0, Dim1_0, Dim2_0, Dim0_1,
