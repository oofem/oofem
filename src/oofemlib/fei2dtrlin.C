...
void
FEI2dTrLin :: evalN(FloatArray &answer, const FloatArray &lcoords, const FEIElementGeometry& cellgeo, double time)
{
    answer.resize(3);
...
void
FEI2dTrLin :: evaldNdx(FloatMatrix &answer, const FloatArray &lcoords, const FEIElementGeometry& cellgeo, double time)
{
...
void
FEI2dTrLin :: local2global(FloatArray &answer, const FloatArray &lcoords, const FEIElementGeometry& cellgeo, double time)
{
    double l1, l2, l3;
    answer.resize(2);
...
int
FEI2dTrLin :: global2local(FloatArray &answer, const FloatArray &coords, const FEIElementGeometry& cellgeo, double time)
{
...
double
FEI2dTrLin :: giveTransformationJacobian(const FloatArray &lcoords, const FEIElementGeometry& cellgeo, double time)
{
    double area, x1, x2, x3, y1, y2, y3;
...
void
FEI2dTrLin :: edgeEvalN(FloatArray &answer, const FloatArray &lcoords, const FEIElementGeometry& cellgeo, double time)
{
...
double
FEI2dTrLin :: edgeGiveTransformationJacobian(int iedge, const FloatArray &lcoords, const FEIElementGeometry& cellgeo, double time)
{
    IntArray edgeNodes;
    this->computeLocalEdgeMapping(edgeNodes, iedge);
...
double
FEI2dTrLin :: edgeComputeLength(IntArray &edgeNodes, const FEIElementGeometry& cellgeo)
{
    double dx, dy;
    int nodeA, nodeB;
