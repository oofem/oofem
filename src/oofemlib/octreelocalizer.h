...
public:
    ...
    virtual ElementGeometry *giveElementContainingPoint(const FloatArray &coords, const Set &eset);
    virtual ElementGeometry *giveElementCloseToPoint(const FloatArray &coords, const IntArray *regionList = NULL);
    virtual ElementGeometry *giveElementClosestToPoint(FloatArray &lcoords, FloatArray &closest, const FloatArray &gcoords, int region);
...
/**
     ...
     */
    ElementGeometry *giveElementContainingPoint(OctantRec *cell, const FloatArray &coords,
