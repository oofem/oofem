...
public:
     ...
     *  @param time time
     */
    virtual void edgeEvalN(FloatArray &answer, const FloatArray &lcoords, const FEIElementGeometry& cellgeo, double time);
    /**
     ...
     *  @param time time
     */
    virtual void surfaceEvalN(FloatArray &answer, const FloatArray &lcoords, const FEIElementGeometry& cellgeo, double time);
    /**
     *  Evaluates the matrix of derivatives of edge interpolation functions (shape functions) at given point.
     *  These derivatives are in global coordinate system (where the nodal coordinates are defined)
     *  @param answer contains resulting matrix of derivatives, the member at i,j position contains value of dNj/dxi
...
protected:
    double edgeComputeLength(IntArray &edgeNodes, const FEIElementGeometry& cellgeo);
...
public:
    void   giveJacobianMatrixAt(FloatMatrix &jacobianMatrix, const FloatArray &lcoords, const FEIElementGeometry& cellgeo);
};
