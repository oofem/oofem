...
public:
  ...
  */
  ...
  {_error ("computeInitialStressMatrix: not implemented"); return;}
...
protected:
  ...
  */
 virtual int  computeLoadGToLRotationMtrx (FloatMatrix& answer) {answer.beEmptyMtrx(); return 0;}
 ...
 /**
  ...
  @return nonzero if transformation matrix is not empty matrix, zero otherwise
  */
 virtual int  computeLoadLEToLRotationMatrix (FloatMatrix& answer, int, GaussPoint*) {answer.beEmptyMtrx(); return 0;}
 /**
  ...
  @return nonzero if transformation matrix is not empty matrix, zero otherwise
  */
 virtual int  computeLoadLSToLRotationMatrix (FloatMatrix& answer, int, GaussPoint*) {answer.beEmptyMtrx(); return 0;}
