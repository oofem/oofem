...
void
VTKBaseExportModule::getNodalVariableFromXFEMST(FloatArray &answer, Node *node, TimeStep *tStep, XFEMStateType xfemstype, Set &region, EnrichmentItem *ei)
{
...
void
VTKBaseExportModule::exportCellVars(VTKPiece &vtkPiece, IntArray& cellVarsToExport, TimeStep *tStep)
{
    Domain *d = emodel->giveDomain(1);
    FloatArray valueArray;
    const IntArray &elems = vtkPiece.getRegionCells();
