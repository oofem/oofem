...
CompRow_ILUPreconditioner :: initializeFrom(InputRecord *ir)
{
    ...
    this->drop_tol = 1.e-8;
    IR_GIVE_OPTIONAL_FIELD(ir, this->drop_tol, IFT_CompRow_ILUPrecond_droptol, "droptol"); // Macro

    part_fill = 5;
    IR_GIVE_OPTIONAL_FIELD(ir, part_fill, IFT_CompRow_ILUPrecond_partfill, "partfill"); // Macro
