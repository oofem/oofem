...
void NTBdivTerm::evaluate_dw (FloatMatrix& answer, MPElement& e, GaussPoint* gp, TimeStep* tstep) const {
    FloatArray Np;
...
void NTBdivTerm::evaluate_c (FloatArray& answer, MPElement& cell, GaussPoint* gp, TimeStep* tstep) const  {
    FloatMatrix A;
    FloatArray u;
    this->evaluate_dw(A, cell, gp, tstep);
    cell.getUnknownVector(u, this->field, this->m, tstep);
    answer.beProductOf(A, u);
}

void NTBdivTerm::getDimensions_dw(Element& cell) const  {
    //int nnodes = interpol.giveNumberOfNodes();
    //int ndofs = v.size;
    //return nnodes*ndofs;
}
...
void deltaBTfiNpTerm::evaluate_dw (FloatMatrix& answer, MPElement& e, GaussPoint* gp, TimeStep* tstep) const {
    FloatArray Nvf, Np;
    FloatMatrix B;   
...
void deltaBTfiNpTerm::evaluate_c (FloatArray& answer, MPElement& cell, GaussPoint* gp, TimeStep* tstep) const  {
    FloatMatrix A;
    FloatArray p;
    this->evaluate_dw(A, cell, gp, tstep);
...
void deltaBTfiNpTerm::getDimensions_dw(Element& cell) const  {
...
void NdTdvfNpTerm::evaluate_dw (FloatMatrix& answer, MPElement& e, GaussPoint* gp, TimeStep* tstep) const {
...
void NdTdvfNpTerm::evaluate_c (FloatArray& answer, MPElement& cell, GaussPoint* gp, TimeStep* tstep) const  {
    FloatMatrix A;
    FloatArray p;
    this->evaluate_dw(A, cell, gp, tstep);
    cell.getUnknownVector(p, this->field, VM_TotalIntrinsic, tstep);
...
void NdTdvfNpTerm::getDimensions_dw(Element& cell) const  {
...
void BTmuBTerm::evaluate_dw (FloatMatrix& answer, MPElement& e, GaussPoint* gp, TimeStep* tstep) const {
    FloatArray nvec,dvf,rvf,Np;
...
void BTmuBTerm::evaluate_c (FloatArray& answer, MPElement& cell, GaussPoint* gp, TimeStep* tstep) const  {
    FloatMatrix A;
    FloatArray r;
    this->evaluate_dw(A, cell, gp, tstep);
...
void BTmuBTerm::getDimensions_dw(Element& cell) const  {
...
void BTmuVfBTerm::evaluate_dw (FloatMatrix& answer, MPElement& e, GaussPoint* gp, TimeStep* tstep) const {
    FloatMatrix B, M(6,6), MB;
...
void BTmuVfBTerm::evaluate_c (FloatArray& answer, MPElement& cell, GaussPoint* gp, TimeStep* tstep) const  {
    FloatMatrix A;
    FloatArray r;
    this->evaluate_dw(A, cell, gp, tstep);
...
void BTmuVfBTerm::getDimensions_dw(Element& cell) const  {
...
void NTmuVfSNTerm::evaluate_dw (FloatMatrix& answer, MPElement& e, GaussPoint* gp, TimeStep* tstep) const {
...
void NTmuVfSNTerm::evaluate_c (FloatArray& answer, MPElement& cell, GaussPoint* gp, TimeStep* tstep) const  {
    FloatMatrix A;
    FloatArray r;
    this->evaluate_dw(A, cell, gp, tstep);
    cell.getUnknownVector(r, this->field, VM_TotalIntrinsic, tstep);
...
void NTmuVfSNTerm::getDimensions_dw(Element& cell) const  {
...
void deltaBTNpTerm::evaluate_dw (FloatMatrix& answer, MPElement& e, GaussPoint* gp, TimeStep* tstep) const {
    FloatArray Nvf, Np;
    FloatMatrix B;   
    deltaB(B, this->testField, this->testField.interpolation, e, gp->giveNaturalCoordinates(), gp->giveMaterialMode());
    this->field.interpolation.evalN(Np, gp->giveNaturalCoordinates(), FEIElementGeometryWrapper(&e));
...
void deltaBTNpTerm::evaluate_c (FloatArray& answer, MPElement& cell, GaussPoint* gp, TimeStep* tstep) const  {
    FloatMatrix A;
    FloatArray p;
    this->evaluate_dw(A, cell, gp, tstep);
    cell.getUnknownVector(p, this->field, VM_TotalIntrinsic, tstep);
...
void deltaBTNpTerm::getDimensions_dw(Element& cell) const  {
