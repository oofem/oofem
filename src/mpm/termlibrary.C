...
void 
NTf_Surface::evaluate_c (FloatArray& answer, MPElement& cell, GaussPoint* gp, TimeStep* tStep) const {
...
void 
NTf_Edge::evaluate_c (FloatArray& answer, MPElement& cell, GaussPoint* gp, TimeStep* tStep) const {
  FloatArray nvec, flux;
  FloatMatrix N;
  const FloatArray& lc = gp->giveNaturalCoordinates();
