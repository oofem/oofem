...
//@{
#define _IFT_FreeConstantSurfaceLoad_LoadOffset "loadoffset"
#define _IFT_FreeConstantSurfaceLoad_Name "freeconstantsurfaceload"
//@}
 ...
 */
class OOFEM_EXPORT FreeConstantSurfaceLoad : public SurfaceLoad
{
public:
    ...
    const char *giveClassName() const override { return "FreeConstantSurfaceLoad"; }
    const char *giveInputRecordName() const override { return _IFT_FreeConstantSurfaceLoad_Name; }
