/*CemPy  Copyright (C) 2008   V. Smilauer
 *
 * Czech Technical University in Prague, Faculty of Civil Engineering,
 * Department of Mechanics, Thakurova 7, 166 29 Prague, Czech Republic
 *
 * D.P. Bentz and E.J. Garboczi are acknowledged for CEMHYD3D core code
 * NIST Building and Fire Research Laboratory, 100 Bureau Drive Mail Stop 8615,
 * 20899 Gaithersburg, Maryland, USA
 *
